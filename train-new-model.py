...
class ImageDataset(Dataset):
    def __init__(self, normal_dir, diseased_dir, transform=None, diseased_sample_size=None):
        ...
        # Subsample diseased images if specified and possible
...
def train_with_kfold(dataset, k_folds=5, num_epochs=50, batch_size=32):
...
if __name__ == "__main__":
    ...
    dataset = ImageDataset(
        normal_dir=normal_dir, diseased_dir=diseased_dir,
        transform=transform,
